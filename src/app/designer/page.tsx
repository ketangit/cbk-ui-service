        ...
        <div className="card controls">
          ...
          {params.nonDeterministic && (
            <p className="muted" style={{ margin: 0 }}>
              A fresh seed is drawn from OS entropy on every generation — each result is unique. The
              drawn seed is shown afterwards so your exact puzzle can still be exported and ordered.
            </p>
          )}
              ...
              <div className="card" style={{ marginTop: 16 }}>
                ...
                <div className="row">
                  ...
                  <button className="button" onClick={addToCart}>
                    {added
                      ? 'Added ✓'
                      : `Add to cart · ${formatPrice(result.priceCentsByMaterial[material])}`}
                  </button>
                </div>
              </div>
